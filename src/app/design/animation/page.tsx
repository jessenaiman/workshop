...
import AnimateCssPage from "./animate-css/page";
import TailwindPage from "./tailwind/page";
import MagicUIPage from "./magicui/page";
...
export default function AnimationPage() {
  ...
  // A simple router based on the path
  const renderContent = () => {
    if (pathname.includes('/tailwind')) {
      return <TailwindPage />;
    }
    if (pathname.includes('/magicui')) {
      return <MagicUIPage />;
    }
    // Default to animate-css
    return <AnimateCssPage />;
  };
